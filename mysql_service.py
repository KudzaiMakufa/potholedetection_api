# author: 
# this is the mysql service used to communicate with the backend. it involves communicating with tables in the pothodet database
import mysql.connector
import random
from datetime import datetime
from flask import jsonify

# connector method for the pothodet db
def connect():
